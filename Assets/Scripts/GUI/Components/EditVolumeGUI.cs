    ...
    public class EditVolumeGUI : MonoBehaviour {
        ...
        private void UpdateWindow(int windowID) {
            ...
            if (targetObject != null) {
                ...
                targetObject.RenderMode = (RenderMode)selectedRenderModeIndex;

                // Visibility window
                GUILayout.Label("Visibility window (min - max visible values)");
                GUILayout.BeginHorizontal();
                Vector2 visibilityWindow = targetObject.VisibilityWindow;
                GUILayout.Label("min:");
                ...
                targetObject.VisibilityWindow = visibilityWindow;
            ...
            if (!result.cancelled) {
                ...
                if (extension == ".tf") {
                    ...
                    if (tf != null) {
                        ...
                        targetObject.TFRenderMode = TFRenderMode.TF1D;
                    }
                }
                if (extension == ".tf2d") {
                    ...
                    if (tf != null) {
                        ...
                        targetObject.TFRenderMode = TFRenderMode.TF2D;
                    }
                }
            }
        }
